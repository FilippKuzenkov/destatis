...
**Stakeholder:** a retail chain's merchandising or expansion-planning lead — someone who'd act on this, not a hypothetical reader.
...
![Power BI Category comparison page: turnover YoY% across online retail, its control, the retail aggregate, and the two divergent siblings](charts/page2_category_comparison.png)
...
**Limitations.** Correlation-style comparisons only, not causal — no control for broader macroeconomic conditions beyond the sector-vs-sector checks above. The series starts January 2024, so no more than one full year of prior-year comparison exists at any point. `WZ08-4741`'s surge and `WZ08-4799`'s collapse are named but not explained by this dataset.
